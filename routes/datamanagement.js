...
// GET /api/forge/datamanagement?id=foo%bar
...
async function getVersions(projectId, itemId, oauthClient, credentials, res) {
    ...
    res.json(versions.body.data.map((version) => {
        ...
        const fileName = version.attributes.fileName;
        const fileType = version.attributes.fileType;
        return createTreeNode(
            viewerUrn,
...
function createTreeNode(_id, _text, _type, _children, _fileType, _fileName) {
